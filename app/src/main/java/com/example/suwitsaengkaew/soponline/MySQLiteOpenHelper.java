...
public class MySQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String DOCUMENTFILE_TABLE = "create table documentfileTABLE (_id integer primary key, doc_id text, doc_number text, doc_subject text, doc_type text, org_name text);";
